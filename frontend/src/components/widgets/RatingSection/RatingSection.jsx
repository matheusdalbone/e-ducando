...
import BackgroundVideo from '../../../assets/gifs/rating-background.mp4';
  ...
  return (
    <section className={styles.ratingSection}>
      ...
      <div className={styles.textSection}>
        ...
        <Text as='h3' weight='400' size='24px' color={COLORS.WHITE_COLOR} lineHeight='32px'>Mais de 10.000 estudantes já transformaram sua forma de aprender conosco</Text>
      </div>
